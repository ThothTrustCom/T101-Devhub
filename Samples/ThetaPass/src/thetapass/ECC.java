...
//	protected static byte[] EC_P256R1_FIELD_A = { (byte)0x7D, (byte)0x5A, (byte)0x09, (byte)0x75,
...
//	protected static byte[] EC_P256R1_FIELD_B = { (byte)0x26, (byte)0xDC, (byte)0x5C, (byte)0x6C,
//	        (byte)0xE9, (byte)0x4A, (byte)0x4B, (byte)0x44,
//	        (byte)0xF3, (byte)0x30, (byte)0xB5, (byte)0xD9,
...
//	protected static byte[] EC_P256R1_FIELD_G = { (byte)0x04,
...
//	protected static byte[] EC_P256R1_FIELD_R = { (byte)0xA9, (byte)0xFB, (byte)0x57, (byte)0xDB,
...
//	protected static byte[] EC_P256R1_FP = { (byte)0xA9, (byte)0xFB, (byte)0x57, (byte)0xDB,
//	        (byte)0xA1, (byte)0xEE, (byte)0xA9, (byte)0xBC,
//	        (byte)0x3E, (byte)0x66, (byte)0x0A, (byte)0x90,
...
//	        (byte)0x1F, (byte)0x6E, (byte)0x53, (byte)0x77 };
	...
	public static boolean checkCurveParameters(ECKey eckey, byte[] tmpbuffer, short tmpoffset) {
		...
		if (0 != Util.arrayCompare(tmpbuffer, tmpoffset, EC_P256R1_FIELD_A, (short) 0,
				(short) EC_P256R1_FIELD_A.length))
			return false;
		eckey.getB(tmpbuffer, tmpoffset);
		if (0 != Util.arrayCompare(tmpbuffer, tmpoffset, EC_P256R1_FIELD_B, (short) 0,
				(short) EC_P256R1_FIELD_B.length))
			return false;
		eckey.getG(tmpbuffer, tmpoffset);
		if (0 != Util.arrayCompare(tmpbuffer, tmpoffset, EC_P256R1_FIELD_G, (short) 0,
				(short) EC_P256R1_FIELD_G.length))
			return false;
		eckey.getR(tmpbuffer, tmpoffset);
		if (0 != Util.arrayCompare(tmpbuffer, tmpoffset, EC_P256R1_FIELD_R, (short) 0,
				(short) EC_P256R1_FIELD_R.length))
			return false;
