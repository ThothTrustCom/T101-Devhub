...
public class HmacSha512 {
	...
	public static short computeHmacSha512(byte[] key, short key_offset, short key_length, 
		...
		CardEdge.sha512.reset();
		CardEdge.sha512.doFinal(data, (short)0, (short)(BLOCKSIZE+message_length), data, BLOCKSIZE);
		...
		CardEdge.sha512.reset();
		CardEdge.sha512.doFinal(data, (short)0, (short)(BLOCKSIZE+HASHSIZE), mac, mac_offset);
