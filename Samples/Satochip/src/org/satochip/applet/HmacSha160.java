...
public class HmacSha160 {
	...
	public static short computeHmacSha160(
		...
		CardEdge.sha160.reset();
		CardEdge.sha160.doFinal(data, (short)0, (short)(BLOCKSIZE+message_length), data, BLOCKSIZE); // copy hash result to data buffer!
		...
		CardEdge.sha160.reset();
		CardEdge.sha160.doFinal(data, (short)0, (short)(BLOCKSIZE+HASHSIZE), mac, mac_offset);
		return HASHSIZE;
	}	
