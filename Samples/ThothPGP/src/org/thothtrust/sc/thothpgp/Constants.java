...
public final class Constants {
     ...
     static final short INTERNAL_BUFFER_MAX_LENGTH =
        (short)0x500;

     static final short APDU_MAX_LENGTH = (short)256;

     static final byte[] KEY_DERIVATION_FUNCTION_DEFAULT = {
     ...
     static final byte[] USER_PIN_DEFAULT = {
     ...
     static final byte[] ADMIN_PIN_DEFAULT = {
        (byte)0x31, (byte)0x32, (byte)0x33, (byte)0x34,
     ...
     static final byte[] HISTORICAL_BYTES = {
     ...
     static final byte[] EXTENDED_CAPABILITIES = {
     ...
     static final short challengeMaxLength() {
        return Util.getShort(EXTENDED_CAPABILITIES, (short)2);
    }

     static final short cardholderCertificateMaxLength() {
        return Util.getShort(EXTENDED_CAPABILITIES, (short)4);
    }

     static final short specialDoMaxLength() {
        return Util.getShort(EXTENDED_CAPABILITIES, (short)6);
    }


     static final byte[] DSI_SHA256_HEADER = {
        (byte)0x30, (byte)0x31,
        (byte)0x30, (byte)0x0D,
     ...
     static final byte[] DSI_SHA384_HEADER = {
        (byte)0x30, (byte)0x41,
        (byte)0x30, (byte)0x0D,
     ...
     static final byte[] DSI_SHA512_HEADER = {
        (byte)0x30, (byte)0x51,
        (byte)0x30, (byte)0x0D,
     ...
     static final byte[] ALGORITHM_ATTRIBUTES_DEFAULT = {
        (byte)0x01, /* RSA */
     ...
     static final byte[] ALGORITHM_ATTRIBUTES_DEFAULT_SECURE_MESSAGING = {
        (byte)0x12, /* ECDH */
